...
class AudioController {
  ...
  /// Paths relative to assets/ (audioplayers adds assets/ prefix).
  static const String _sfxPath = 'sfx';
  static const String _musicPath = 'music';
  ...
  Future<void> _playCurrentSongInPlaylist() async {
    ...
    try {
      await _musicPlayer.play(
        AssetSource('$_musicPath/${_playlist.first.filename}'),
      );
    } catch (e) {
